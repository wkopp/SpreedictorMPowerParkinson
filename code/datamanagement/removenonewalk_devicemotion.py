...
class RemoveNoneWalkDeviceMotionOutbound(RemoveNoneWalkDeviceMotion):
    ...
    def __init__(self, reload_ = False, training = True, rmnan = True):
        RemoveNoneWalkDeviceMotion.__init__(self, "outbound", reload_, training, rmnan)
...
class RemoveNoneWalkDeviceMotionRest(RemoveNoneWalkDeviceMotion):
    ...
    '''
    def __init__(self, reload_ = False, training = True, rmnan = True):
        RemoveNoneWalkDeviceMotion.__init__(self, "rest", reload_, training, rmnan)
...
class RemoveNoneWalkDeviceMotionReturn(RemoveNoneWalkDeviceMotion):
    ...
    '''
    def __init__(self, reload_ = False, training = True, rmnan = True):
        RemoveNoneWalkDeviceMotion.__init__(self, "return", reload_, training, rmnan)
