...
class FilterLowPassRawRotationRate(NumpyDataset):

    def __init__(self, variant, reload_ = False, training = True):
        self.npcachefile = os.path.join(datadir,
                "filter_lp_rawrotationrate_{}.pkl".format(variant))
...
class FilterLowPassRawRotationRateOutbound(FilterLowPassRawRotationRate):
    '''
    WorldCoord userAcceleration data for outbound walk
    '''
    def __init__(self, reload_ = False, training = True):
        FilterLowPassRawRotationRate.__init__(self, "outbound", reload_, training)

class FilterLowPassRawRotationRateRest(FilterLowPassRawRotationRate):
    '''
    WorldCoord userAcceleration data for rest phase
    '''
    def __init__(self, reload_ = False, training = True):
        FilterLowPassRawRotationRate.__init__(self, "rest", reload_, training)

class FilterLowPassRawRotationRateReturn(FilterLowPassRawRotationRate):
    '''
    WorldCoord userAcceleration data for return walk
    '''
    def __init__(self, reload_ = False, training = True):
        FilterLowPassRawRotationRate.__init__(self, "return", reload_, training)
