...
class SvdUserAccelOutbound(SvdUserAccel):
    ...
    def __init__(self, reload_ = False, training = True, rmnan = True):
        SvdUserAccel.__init__(self, "outbound", reload_, training, rmnan)
...
class SvdUserAccelRest(SvdUserAccel):
    ...
    '''
    def __init__(self, reload_ = False, training = True, rmnan = True):
        SvdUserAccel.__init__(self, "rest", reload_, training, rmnan)
...
class SvdUserAccelReturn(SvdUserAccel):
    ...
    '''
    def __init__(self, reload_ = False, training = True, rmnan = True):
        SvdUserAccel.__init__(self, "return", reload_, training, rmnan)
