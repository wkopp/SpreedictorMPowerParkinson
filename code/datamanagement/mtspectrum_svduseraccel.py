...
class MtSpectrum_SvdUserAccelOutbound(MtSpectrum_SvdUserAccel):
    ...
    def __init__(self, reload_ = False, training = True, rmnan = True):
        MtSpectrum_SvdUserAccel.__init__(self, "outbound", reload_, training, rmnan)
...
class MtSpectrum_SvdUserAccelRest(MtSpectrum_SvdUserAccel):
    ...
    '''
    def __init__(self, reload_ = False, training = True, rmnan = True):
        MtSpectrum_SvdUserAccel.__init__(self, "rest", reload_, training, rmnan)
...
class MtSpectrum_SvdUserAccelReturn(MtSpectrum_SvdUserAccel):
    ...
    '''
    def __init__(self, reload_ = False, training = True, rmnan = True):
        MtSpectrum_SvdUserAccel.__init__(self, "return", reload_, training, rmnan)
