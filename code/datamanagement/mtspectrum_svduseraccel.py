...
class MtSpectrum_SvdUserAccelOutbound(MtSpectrum_SvdUserAccel):
    ...
    def __init__(self, reload_ = False):
        MtSpectrum_SvdUserAccel.__init__(self, "outbound", reload_)
...
class MtSpectrum_SvdUserAccelRest(MtSpectrum_SvdUserAccel):
    ...
    '''
    def __init__(self, reload_ = False):
        MtSpectrum_SvdUserAccel.__init__(self, "rest", reload_)
...
class MtSpectrum_SvdUserAccelReturn(MtSpectrum_SvdUserAccel):
    ...
    '''
    def __init__(self, reload_ = False):
        MtSpectrum_SvdUserAccel.__init__(self, "return", reload_)
