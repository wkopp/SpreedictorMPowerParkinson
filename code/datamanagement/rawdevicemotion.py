...
class RawDeviceMotionOutbound(RawDeviceMotion):
    ...
    def __init__(self, reload_ = False, training = True, rmnan = True):
        RawDeviceMotion.__init__(self, "outbound", reload_, training, rmnan)
...
class RawDeviceMotionRest(RawDeviceMotion):
    ...
    '''
    def __init__(self, reload_ = False, training = True, rmnan = True):
        RawDeviceMotion.__init__(self, "rest", reload_, training, rmnan)
...
class RawDeviceMotionReturn(RawDeviceMotion):
    ...
    '''
    def __init__(self, reload_ = False, training = True, rmnan = True):
        RawDeviceMotion.__init__(self, "return", reload_, training, rmnan)
