...
class NonYDeviceMotionOutbound(NonYDeviceMotion):
    ...
    def __init__(self, reload_ = False, training = True, rmnan = True):
        NonYDeviceMotion.__init__(self, "outbound", reload_, training, rmnan)
...
class NonYDeviceMotionRest(NonYDeviceMotion):
    ...
    '''
    def __init__(self, reload_ = False, training = True, rmnan = True):
        NonYDeviceMotion.__init__(self, "rest", reload_, training, rmnan)
...
class NonYDeviceMotionReturn(NonYDeviceMotion):
    ...
    '''
    def __init__(self, reload_ = False, training = True, rmnan = True):
        NonYDeviceMotion.__init__(self, "return", reload_, training, rmnan)
